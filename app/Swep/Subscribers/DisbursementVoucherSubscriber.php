...
class DisbursementVoucherSubscriber extends BaseSubscriber{
	...
	public function onStore($disbursement_voucher){
        ...
        $this->cacheHelper->deletePattern('swep_cache:disbursement_vouchers:all:*');
        $this->cacheHelper->deletePattern('swep_cache:disbursement_vouchers:byUser:'. $disbursement_voucher->user_id .':*');
    ...
    public function onUpdate($disbursement_voucher){
        ...
        $this->cacheHelper->deletePattern('swep_cache:disbursement_vouchers:all:*');
        $this->cacheHelper->deletePattern('swep_cache:disbursement_vouchers:byUser:'. $disbursement_voucher->user_id .':*');
        $this->cacheHelper->deletePattern('swep_cache:disbursement_vouchers:bySlug:'. $disbursement_voucher->slug .'');
