...
class DocumentSubscriber extends BaseSubscriber{
    ...
    public function onStore($document){
        ...
        $this->__cache->deletePattern('swep_cache:documents:fetch:*');
        $this->__cache->deletePattern('swep_cache:documents:fetchByFolderCode:'. $document->folder_code .'');
    ...
    public function onUpdate($document){
        ...
        $this->__cache->deletePattern('swep_cache:documents:fetch:*');
        $this->__cache->deletePattern('swep_cache:documents:fetchByFolderCode:'. $document->folder_code .'');
        $this->__cache->deletePattern('swep_cache:documents:findBySlug:'. $document->slug .'');
