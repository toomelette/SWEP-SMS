...
class EmployeeServiceRecordSubscriber extends BaseSubscriber{
    ...
    public function onStore($employee_sr){
        ...
        $this->__cache->deletePattern('swep_cache:employees:service_records:getByEmpNo:'. $employee_sr->employee_no .'');
    ...
    public function onUpdate($employee_sr){
        ...
        $this->__cache->deletePattern('swep_cache:employees:service_records:getByEmpNo:'. $employee_sr->employee_no .'');
        $this->__cache->deletePattern('swep_cache:employees:service_records:getBySlug:'. $employee_sr->slug .'');
