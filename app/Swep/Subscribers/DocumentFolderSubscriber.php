...
class DocumentFolderSubscriber extends BaseSubscriber{
    ...
    public function onStore(){
        ...
        $this->__cache->deletePattern('swep_cache:document_folders:all:*');
        $this->__cache->deletePattern('swep_cache:document_folders:global:all');
    ...
    public function onUpdate($doc_folder){
        ...
        $this->__cache->deletePattern('swep_cache:document_folders:all:*');
        $this->__cache->deletePattern('swep_cache:document_folders:global:all');
        $this->__cache->deletePattern('swep_cache:document_folders:bySlug:'. $doc_folder->slug .'');
