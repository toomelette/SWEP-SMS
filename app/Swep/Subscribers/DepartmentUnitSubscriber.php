...
class DepartmentUnitSubscriber extends BaseSubscriber{
    ...
    public function onStore($department_unit){
        ...
        $this->__cache->deletePattern(''. config('app.name') .'_cache:department_units:fetch:*');
        $this->__cache->deletePattern(''. config('app.name') .'_cache:department_units:getAll');
        $this->__cache->deletePattern(''. config('app.name') .'_cache:department_units:getByDepartmentName:'. $department_unit->department_name .'');
        $this->__cache->deletePattern(''. config('app.name') .'_cache:department_units:getByDepartmentId:'. $department_unit->department_id .'');
    ...
    public function onUpdate($department_unit){
        ...
        $this->__cache->deletePattern(''. config('app.name') .'_cache:department_units:getByDepartmentName:'. $department_unit->department_name .'');
        $this->__cache->deletePattern(''. config('app.name') .'_cache:department_units:getByDepartmentId:'. $department_unit->department_id .'');
        $this->__cache->deletePattern(''. config('app.name') .'_cache:department_units:findBySlug:'. $department_unit->slug .'');
        $this->__cache->deletePattern(''. config('app.name') .'_cache:department_units:findByDeptUnitId:'. $department_unit->department_unit_id .'');
