  ...
  <div class="wrapper">
      ...
      <div class="row" style="padding:20px;">
        ...
        <div class="col-md-12">
            ...
            <div class="col-sm-8" style="text-align: center; padding-right:100px;">
      ...
      <div class="row" style="border-top:solid;">
        ...
        <div class="col-sm-2 div-height" style="border-right:solid; line-height: 1; text-align: center;"> 
        ...
        <div class="col-sm-10 div-height">
          <p>Test</p>
        </div>
      ...
      <div class="row" style="border-top:solid; overflow:hidden;">
        ...
        <div class="col-sm-2 div-height" style="border-right:solid;"> 
          <p style="font-size:12px; padding-top:12px; padding-bottom:5px; padding-left: 3px; font-weight:bold;">Payee:</p>
        </div>

        <div class="col-sm-4 div-height" style="border-right:solid; padding-left: 0;">
          <span style="font-size:12px; font-weight:bold; word-wrap: break-word; margin-left: 2px;">{!! $disbursement_voucher->payee !!}</span>
        </div>

        <div class="col-sm-3 div-height" style="border-right:solid; line-height: 1.3; padding-left:0;">
      ...
      <div class="row" style="border-top:solid; overflow:hidden;">
        ...
        <div class="col-sm-2 div-height" style="border-right:solid;"> 
          <p style="font-size:12px; padding-top:15px; padding-bottom:5px; padding-left: 3px; font-weight:bold;">Address:</p>
        </div>
        ...
        <div class="col-sm-6" style="padding:0%; margin-top:-6px; overflow:hidden;">
          ...
          <div class="col-sm-6" style="border-right:solid; padding-left:0;">
      ...
      <div class="row" style="border-top:solid;">
        ...
        <div class="col-sm-9" style="border-right:solid; text-align: center; padding-top:2px; padding-bottom:2px;"> 
      ...
      {{-- EXPLANATION VALUE --}}
      <div class="row" style="border-top:solid; height:20em; overflow: hidden;">
        
        <div class="col-sm-9" style="border-right:solid; padding-left:20px; margin-bottom: -200px; padding-bottom: 200px;"> 
        ...
        <div class="col-sm-3" style="border-right:solid; text-align: center; padding-top: 20px;"> 
      ...
      <div class="row" style="border-top:solid;">
        ...
        <div class="col-sm-6" style="border-right:solid;"> 
          <span style="border-right: solid; border-bottom: solid; padding:4px; font-weight:bold;">A</span>
        ...
        <div class="col-sm-6 div-height" style="border-right:solid; padding-left: 0;"> 
          <span style="border-right: solid; border-bottom: solid; padding:4px; font-weight:bold;">B</span>
      ...
      <div class="row" style="border-top:solid;">
        ...
        <div class="col-sm-4 div-height" style="border-right:solid;">
          &nbsp;
        </div>

        <div class="col-sm-2 div-height" style="border-right:solid; padding-left:0;"> 
          <span style="font-size:12px;">&nbsp;Signature:</span>
        </div>
      ...
      <div class="row" style="border-top:solid;">
        ...
        <div class="col-sm-4" style="border-right:solid; padding:0%; margin-top:-6px; overflow:hidden;">

          <div class="col-sm-12" style="border-bottom:solid; width: 100%; padding-top:5px; padding-bottom:5px;">
            @foreach($global_signatories_all as $data)
              @if($data->type == 2)
      ...
      <div class="row" style="border-top:solid;">
        ...
        <div class="col-sm-2" style="border-right:solid;"> 
        ...
        <div class="col-sm-2" style="border-right:solid; padding-left:0;"> 
          <span style="font-size:12px;">&nbsp;Date:</span>
        </div>
      ...
      <div class="row" style="padding-bottom: 10px;">
        ...
        <div class="col-sm-2 div-height" style="border-right:solid; border-top: solid;">
        ...
        <div class="col-sm-1 div-height" style="border-right:solid; border-top: solid; padding-left:0;"> 
         <p style="font-size:9px;">&nbsp;Date:</p>
        </div>

        <div class="col-sm-3 div-height" style="border-right:solid; border-top: solid; padding-left:0;"> 
      ...
      {{-- SIGNATURE 2 --}}
      <div class="row" style="padding-bottom: 10px; border-top:solid;">
        ...
        <div class="col-sm-1" style="border-right:solid; padding-left:0;"> 
         <p style="font-size:9px;">&nbsp;Date:</p>
        </div>

        <div class="col-sm-3" style="border-right:solid; padding-left:0;"> 
      ...
      <div class="row" style="padding-bottom: 10px;">
        ...
        <div class="col-sm-8 div-height" style="border-right:solid; border-top:solid;">
...
<div class="row">
  ...
  <div class="col-sm-4 div-height" style="border-right:solid; padding-left:0; line-height: 1.2;"> 
    <span style="font-size:12px;">FM-AFD-ACC-001, Rev. 00</span>
    <br><span style="font-size:12px;">Effective Date : March 12, 2015</span>
  </div>
