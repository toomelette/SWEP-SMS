...
<div style="border:solid;">
  ...
  <div class="wrapper">
      ...
      {{-- DOCUMENT NAME --}}
      <div class="row" style="border-top:solid 1.5px;">
        
        <div class="col-sm-9" style="border-right:solid 1.5px; text-align: center; padding-top:9px; padding-bottom:9px;"> 
      ...
      <div class="row" style="border-top:solid 1.5px;">
        ...
        <div class="col-sm-2 div-height" style="border-right:solid 1.5px; line-height: 1; text-align: center;"> 
        ...
        <div class="col-sm-10" style="padding-top:5px;">
          @foreach($global_mode_of_payment_all as $data)
            <div class="col-sm-1" style="padding-left: 50px;">
              ...
              @else
                <div style="width: 20px; height: 20px; border: 1.5px solid;"></div>
              @endif
            </div>
      ...
      {{-- PAYEE --}}
      <div class="row" style="border-top:solid 1.5px; overflow:hidden;">
        
        <div class="col-sm-2 div-height" style="border-right:solid 1.5px;"> 
          <p style="font-size:12px; padding-top:10px; padding-bottom:5px; padding-left: 3px; font-weight:bold;">Payee:</p>
        </div>

        <div class="col-sm-4 div-height" style="border-right:solid 1.5px; padding-left: 0;">
          <span style="font-size:12px; font-weight:bold; word-wrap: break-word; margin-left: 2px;">{!! $disbursement_voucher->payee !!}</span>
        </div>

        <div class="col-sm-3 div-height" style="border-right:solid 1.5px; line-height: 1.3; padding-left:0;">
      ...
      <div class="row" style="border-top:solid 1.5px; overflow:hidden;">
        ...
        <div class="col-sm-6" style="padding:0%; margin-top:-6px; overflow:hidden;">
          ...
          <div class="col-sm-12" style="border-bottom:solid 1.5px; width: 100%; text-align: center;">
            <span style="font-size:10px; font-weight:bold;">Resposibility Center</span>
          </div>

          <div class="col-sm-6" style="border-right:solid 1.5px; padding-left:0; line-height:1.3;">
      ...
      <div class="row" style="border-top:solid 1.5px;">
        ...
        <div class="col-sm-9" style="border-right:solid 1.5px; text-align: center; padding-top:2px; padding-bottom:2px;"> 
      ...
      {{-- EXPLANATION VALUE --}}
      <div class="row" style="border-top:solid 1.5px; height:23em; overflow: hidden;">
        
        <div class="col-sm-9" style="border-right:solid 1.5px; padding-left:20px; margin-bottom: -300px; padding-bottom: 300px;"> 
        ...
        <div class="col-sm-3" style="border-right:solid 1.5px; text-align: center; padding-top: 20px;"> 
      ...
      <div class="row" style="border-top:solid 1.5px;">
        ...
        <div class="col-sm-6" style="border-right:solid 1.5px;"> 
          <span style="border-right: solid 1.5px; border-bottom: solid 1.5px; padding:4px; font-weight:bold;">A</span>
        ...
        <div class="col-sm-6 div-height" style="border-right:solid 1.5px; padding-left: 0;"> 
          <span style="border-right: solid 1.5px; border-bottom: solid 1.5px; padding:4px; font-weight:bold;">B</span>
      ...
      {{-- SIGNATURES --}}
      <div class="row" style="border-top:solid 1.5px; margin-top: -2px; margin-bottom:5px;">
        
        <div class="col-sm-2 div-height" style="border-right:solid 1.5px;"> 
          <span style="font-size:12px;">&nbsp;Signature:</span>
        </div>

        <div class="col-sm-4 div-height" style="border-right:solid 1.5px;">
          &nbsp;
        </div>

        <div class="col-sm-2 div-height" style="border-right:solid 1.5px; padding-left:0;"> 
          <span style="font-size:12px;">&nbsp;Signature:</span>
        </div>
      ...
      <div class="row" style="border-top:solid 1.5px; overflow: hidden;">
        ...
        <div class="col-sm-4" style="border-right:solid 1.5px; padding:0%; margin-top:-6px; overflow:hidden;">

          <div class="col-sm-12" style="border-bottom:solid 1.5px; width: 100%; padding-top:5px; padding-bottom:5px;">
            @foreach($global_signatories_all as $data)
              @if($data->type == 2)
      ...
      <div class="row" style="border-top:solid 1.5px;">
        ...
        <div class="col-sm-2" style="border-right:solid 1.5px; overflow: hidden"> 
          <span style="font-size:12px;">&nbsp;Date:</span>
        </div>

        <div class="col-sm-4" style="border-right:solid 1.5px;">
          &nbsp;
        </div>

        <div class="col-sm-2" style="border-right:solid 1.5px; padding-left:0;"> 
          <span style="font-size:12px;">&nbsp;Date:</span>
        </div>
      ...
      <div class="row" style="border-top:solid 1.5px;">
        ...
        <div class="col-sm-8" style="border-right:solid 1.5px;"> 
          <span style="border-right: solid 1.5px; padding-top:4px; padding-right:4px; padding-left:4px; padding-bottom:2px; font-weight:bold;">C</span>
          <span style="font-weight:bold; font-weight:bold; margin-left:10px;">Received Payment:</span>
        </div>

        <div class="col-sm-4" style="border-right:solid 1.5px; padding-left:0;"> 
      ...
      <div class="row" style="padding-bottom: 5px; overflow:hidden;">
        ...
        <div class="col-sm-2 div-height" style="border-right:solid 1.5px; border-top: solid 1.5px;">
        ...
        <div class="col-sm-1 div-height" style="border-right:solid 1.5px; border-top: solid 1.5px; padding-left:0;"> 
         <p style="font-size:9px;">&nbsp;Date:</p>
        </div>

        <div class="col-sm-3 div-height" style="border-right:solid 1.5px; border-top: solid 1.5px; padding-left:0;"> 
      ...
      {{-- SIGNATURE 2 --}}
      <div class="row" style="padding-bottom: 5px; border-top:solid 1.5px; overflow:hidden;">
        ...
        <div class="col-sm-1 div-height" style="border-right:solid 1.5px; padding-left:0;"> 
         <p style="font-size:9px;">&nbsp;Date:</p>
        </div>

        <div class="col-sm-3 div-height" style="border-right:solid 1.5px; padding-left:0;"> 
      ...
      <div class="row" style="padding-bottom: 5px;">
        ...
        <div class="col-sm-8 div-height" style="border-right:solid 1.5px; border-top:solid 1.5px;">
