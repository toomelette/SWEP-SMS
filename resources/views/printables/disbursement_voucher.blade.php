...
<div style="border:solid;">
  ...
  <div class="wrapper">
      ...
      {{-- EXPLANATION VALUE --}}
      <div class="row" style="border-top:solid 1.4px; height:23em; overflow: hidden;">
        
        <div class="col-sm-9" style="border-right:solid 1.4px; padding-left:20px; margin-bottom: -300px; padding-bottom: 300px;"> 
