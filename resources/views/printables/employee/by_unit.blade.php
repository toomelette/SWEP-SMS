...
<head>
  ...
  <style type="text/css">
    ...
    th{
      ...
      background-color: #FBA773 !important;
    }
...
<body onload="window.print();" onafterprint="window.close()">
  ...
  <div class="row">
    ...
    <div class="col-sm-12" style="text-align: center; padding-bottom:10px;">
      ...
      <span style="font-weight: bold;">PLACE OF ASSIGNMENT</span><br>
  ...
  @foreach ($dept_units as $data)
    <div style="padding-bottom: 20px; margin-left: 100px;">

      <div class="col-sm-12" style="padding-bottom:7px;">
        <span style="font-weight: bold; font-size: 16px;">{{ $data->description }}</span>
      </div>
      ...
      <table style="border: 1px solid black; font-size: 9px;">
        ...
        @foreach ($data->employee as $key => $data)
