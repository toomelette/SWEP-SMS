<div class="btn-group">
    ...
    <div class="btn-group btn-group-sm" role="group">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            ...
            @if($data->status == 1)
                <li>
                    <a href="#" uri="{{route('dashboard.weekly_report.saveAsNew',$data->slug)}}" data="{{$data->slug}}" class="saveAsNewBtn" reportNo="{{$data->report_no}}" cropYear="{{$data->crop_year}}" data-toggle="tooltip" title="Delete" data-placement="top">
                        <i class="fa fa-save"></i> Save as new
                    </a>
                </li>
            @endif
        </ul>
