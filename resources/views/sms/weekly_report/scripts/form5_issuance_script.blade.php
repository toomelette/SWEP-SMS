        ...
        issuancesOfSro_tbl = $("#form5_issuancesOfSro_table").DataTable({
            ...
            "initComplete": function( settings, json ) {
                $('#tbl_loader').fadeOut(function(){
                    $("#form5_issuancesOfSro_table_container").fadeIn();
                    if(find != ''){
                        issuancesOfSro_tbl.search(find).draw();
                        setTimeout(function(){
                            active_form5_issuancesOfSro = '';
                        },3000);
                ...
                setTimeout(function () {
                    issuancesOfSro_tbl.page({{\Illuminate\Support\Facades\Request::get('toPage')}}).draw('page');
