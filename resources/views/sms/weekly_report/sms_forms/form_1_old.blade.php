            ...
            <div class="box box-sm box-default box-solid">
                ...
                <div class="box-body" style="">
                    <table class="table table-bordered table-condensed table_dynamic" id="form1_raw_sugar_issuances">
                        ...
                        <tbody>
                            @foreach(\App\Swep\Helpers\Arrays::sugarClasses() as $sc)
                                @if(!empty($wr->form1->$sc) || !empty($wr->form1->{'prev_'.$sc}))
                                    @include('sms.dynamic_rows.form1_raw_sugar_issuances',['data'=>$wr->form1,'sugarClass' => $sc])
                                @endif
                            @endforeach
                        </tbody>
                    </table>
