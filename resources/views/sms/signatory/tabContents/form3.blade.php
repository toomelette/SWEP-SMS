...
<div class="row">
        ...
        <div class="panel">
            <div class="box box-sm box-default box-solid">
                <div class="box-header with-border">
                    <p class="no-margin">CERTIFIED: (Mill Representative)<small id="filter-notifier" class="label bg-blue blink"></small></p>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="box box-sm box-default box-solid">
                <div class="box-header with-border">
                    <p class="no-margin">CERTIFIED: (SRA MILL DISTRICT REG. OFFICER)<small id="filter-notifier" class="label bg-blue blink"></small></p>
                    <div class="box-tools pull-right">
                    </div>
                ...
                <div class="box-body" style="">
                    ...
                    <hr>
                    <div class="row">
                        {!! \App\Swep\ViewHelpers\__form2::textbox('signatories['.$form.'][sign3a][name]',[
                            'label' => 'Name:',
                            'cols' => 12,
                            'container_class' =>'signatories_'.$form.'_sign3a_name',
                        ],
                        $signatories[$form]['sign3a']['name'] ?? null
                        ) !!}
                        {!! \App\Swep\ViewHelpers\__form2::textbox('signatories['.$form.'][sign3a][position]',[
                            'label' => 'Position:',
                            'cols' => 12,
                            'container_class' =>'signatories_'.$form.'_sign3a_position',
                        ],
                        $signatories[$form]['sign3a']['position'] ?? null
                        ) !!}
                    </div>
                </div>
