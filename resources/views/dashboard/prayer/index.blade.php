...
<head>
    ...
    <link href="{{asset('day/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
    ...
    <link href="{{asset('day/assets/css/style.css')}}" rel="stylesheet">
...
{{--    <div>{{Carbon::now()->format('F d, Y')}}</div> | <div id="">{{Carbon::now()->format('h:i:s')}}</div>--}}
{{--</section>--}}
...
<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <h1 class="logo"><a href="index.html">SUGAR REGULATORY ADMINISTRATION</a></h1>
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="#about">Announcements</a></li>
...
<section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="500">
        <div class="row">
            <div class="col-md-6">
                <h1 style="font-family: Bebas Neue; margin-bottom: 2rem">
                    NOV 15, 2021
                </h1>
                <h1 style="font-family: Bebas Neue; font-size: 8rem" id="seconds">

                </h1>
            </div>
            <div class="col-md-6">
                <h1>QUOTE OF THE DAY</h1>
                <h2 style="margin-bottom: 3px">{{$qod['text']}}</h2>
                <h2 style="font-style: italic;font-size: 1rem">-{{ ($qod['author']) == null ? 'Unknown Author' : $qod['author']  }}</h2>
            </div>
        </div>
...
{{--    </section><!-- End Clients Section -->--}}
    ...
    <!-- ======= Services Section ======= -->
    <section id="prayers" class="prayers">
        <div class="container">
...
{{--                <p>Sit sint consectetur velit quisquam cupiditate impedit suscipit alias</p>--}}
            ...
            <div>
                <iframe width="420" height="345" src="https://www.youtube.com/embed/tgbNymZ7vqY?autoplay=1" allow="autoplay; encrypted-media">
                </iframe>
            </div>
...
{{--            </div>--}}
    ...
    <h1>Scroll to element using css selectors</h1>
    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        setInterval(function () {
            ...
            if(now.format('HH:mm:ss') == "{{\App\Models\SuSettings::query()->where('setting','afternoon_prayer')->first()->time_value}}"){
                $("[data-scroll-to]").click();
                $("#video_container").show(function () {
                    $("#video").get(0).play();
