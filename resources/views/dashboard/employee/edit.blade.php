            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="pi">
                <div class="row">
                  ...
                  {!! FormHelper::select_static(
                    '3', 'citizenship', 'Citizenship *', old('citizenship') ? old('citizenship') : $employee->citizenship, ['Filipino' => 'FIL', 'Dual Citizenship' => 'DC'], $errors->has('citizenship'), $errors->first('citizenship'), '', ''
                  ) !!}
              ...
              <div class="tab-pane" id="ad">
                <div class="row">
                  ...
                  {!! FormHelper::select_static(
                    '3', 'is_active', 'Status *', old('is_active') ? old('is_active') : DataTypeHelper::boolean_to_string($employee->is_active), ['ACTIVE' => 'true', 'INACTIVE' => 'false'], $errors->has('is_active'), $errors->first('is_active'), '', ''
                  ) !!}
                        ...
                        @else
                          ...
                          @foreach($employee->employeeEducationalBackground as $key => $data)
                            <tr>
                              ...
                              <td>
                                {!! FormHelper::datepicker_for_dt('row_eb['. $key .'][date_from]', $data->date_from, '') !!}
                              </td>

                              <td>
                                {!! FormHelper::datepicker_for_dt('row_eb['. $key .'][date_to]', $data->date_to, '') !!}
                              </td>
