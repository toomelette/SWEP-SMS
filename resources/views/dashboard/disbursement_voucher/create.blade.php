    ...
    <div class="box">
      ...
      <form role="form" method="POST" autocomplete="off" action="{{ route('dashboard.disbursement_voucher.store') }}">
        ...
        <div class="box-body">
          ...
          {!! FormHelper::select_dynamic(
            '2', 'department_name', 'Department:', old('department_name'), $global_departments_all, 'department_id', 'name', $errors->has('department_name'), $errors->first('department_name')
          ) !!}
...
@section('scripts')
  ...
  @include('scripts.disbursement_voucher.disbursement_voucher_create')
