          ...
          <div class="col-md-6">
            <div class="panel panel-default">
              <div class="panel-body">
                  <div class="col-md-12">
                    {!! __form::textbox(
                    '8', 'certified_by', 'text', 'Certified by:', 'Certified by', old('certified_by'), $errors->has('certified_by'), $errors->first('certified_by'), 'data-transform="uppercase" list="certified_list"'
                    ) !!}
                    @php 
                    ...
                    {!! __form::textbox(
                      '8', 'certified_by_position', 'text', 'Position', 'Position', old('certified_by_position'), $errors->has('certified_by_position'), $errors->first('certified_by_position'), 'data-transform="uppercase" list="certified_list_position"'
                    ) !!}
          ...
          <div class="col-md-6">
            <div class="panel panel-default">
              <div class="panel-body">
                  <div class="col-md-12">
                    {!! __form::textbox(
                    '8', 'approved_by', 'text', 'Approved for payment by:', 'Approved by', old('approved_by'), $errors->has('approved_by'), $errors->first('approved_by'), 'data-transform="uppercase" list="approved_list"'
                    ) !!}
                    @php 
                    ...
                    {!! __form::textbox(
                      '8', 'approved_by_position', 'text', 'Position', 'Position', old('approved_by_position'), $errors->has('approved_by_position'), $errors->first('approved_by_position'), 'data-transform="uppercase" list="approved_list_position"'
                    ) !!}
