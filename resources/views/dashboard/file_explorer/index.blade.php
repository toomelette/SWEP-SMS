                            ...
                            <div class="content-panel">
                                ...
                                <div class="drive-wrapper drive-list-view">
                                    <div class="table-responsive drive-items-table-wrapper">
                                        @php
                                            if(request()->has('dir')){
                                                $iterator = new DirectoryIterator(dirname('E:/home/swep_afd_storage'.request('dir').'/*'));
                                            }else{
                                               $iterator = new DirectoryIterator(dirname('E:/home/swep_afd_storage/*'));
                                            }
                                                ...
                                                @if(!$fileinfo->isDot())
                                                    @if($fileinfo->isDir())
                                                        <tr>
                                                            ...
                                                            <td class="name truncate"><a href="{{request()->fullUrl()}}/{{$fileinfo->getFilename()}}">{{$fileinfo->getFilename()}}</a></td>
                                                            <td class="date">{{\Carbon\Carbon::createFromTimestamp($fileinfo->getMTime())->format('F d, Y')}}</td>
                                                            <td class="size">- - - </td>
                                                        </tr>
                                                    @else
                                                        <tr>
                                                            <td class="type"><i class="fa fa-file-pdf-o text-danger"></i></td>
                                                            <td class="name truncate"><a href="#">{{$fileinfo->getFilename()}}</a></td>
                                                            <td class="date">{{\Carbon\Carbon::createFromTimestamp($fileinfo->getMTime())->format('F d, Y')}}</td>
                                                            <td class="size">{{__html::file_size($fileinfo->getSize())}}</td>
                                                        </tr>
                                                    @endif
                                                @endif
                                            @endforeach
